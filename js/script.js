                          ...
                          if (result.isConfirmed) {
                            Swal.fire({
                              ...
                              inputValidator: (value) => {
                                if (!value) {
                                  return 'Isi dulu dong virtualku'
                                }
                              }
                            }).then((result) => {
                              Swal.fire('Okey virtualkuu', 'Nanti aku kabulin kemauan kamu yaa', 'success').then((result) => {
                                Swal.fire("See ya! Aku tunggu di real life ^^").then((result) => {
                                  selesai()
                                });
                              })
                            })
